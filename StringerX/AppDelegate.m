...
- (void)loadWeb {
  ...
  NSString *html = [NSString stringWithFormat:@"<style type=\"text/css\">img {max-width: 100%%; height: auto}</style><h1>%@</h1><div style=\"color: gray\">%@</div><div style=\"color: gray\">%@</div><div style=\"max-width:800px; margin: 0 auto;\">%@</div>",
                    item[@"title"],
                    item[@"author"],
